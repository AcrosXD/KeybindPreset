...
public class CustomGuiControls extends GuiScreen
{
    ...
    public long time;
    private CustomGuiKeyBindingList keyBindingList;
    private GuiButton buttonReset;

    public CustomGuiControls(GuiScreen screen, GameSettings settings)
    {
    ...
    public void initGui()
    {
        this.keyBindingList = new CustomGuiKeyBindingList(this, this.mc);

        this.buttonList.add(new GuiButton(1858, 120, 10, 100, 20, "Add as preset"));
        this.buttonList.add(new PresetGuiButton(1814 ,10 ,10));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        else if(button.id == 1814){
            this.mc.displayGuiScreen(new PresetGui());
        }
        else if (button.id == 1858){
            this.mc.displayGuiScreen(new AddPresetGui());
        }
